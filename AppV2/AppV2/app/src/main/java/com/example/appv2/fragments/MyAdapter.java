        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedFile.isDirectory()){
                    ...
                    try {
                    String file_abs_path=selectedFile.getAbsolutePath();

                    Intent intent_cd = new Intent(context,Setting.class);
                    intent_cd.putExtra("path",file_abs_path);
                    context.startActivity(intent_cd);
